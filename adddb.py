...
print ("<form name='myForm' method='post' action='addfn.py'>")
print ("Member ID:")
print ("<Br>")
...
print ("Date of Birth") 
print ("<Br>")
print ("<input type='text' name='DOB'><br>")
print ("<Br>")
print ("Rank") 
print ("<Br>")
print ("<input type='text' name='Rank'><br>")
print ("<Br>")
print ("<input type='submit' name='subbtn' value='Add to DB'>")
